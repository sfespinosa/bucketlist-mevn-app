<template>
  <div id='app'>
    ...
    <div class="notification" v-for="(item, i) in items" :key="item._id">
      <div class="columns">
        <input class="column input" v-if="isSelected(item)" type="text" v-model="editedDescription" />
        ...
        <div class="column is-narrow">
          ...
          <span class="icon has-text-info" @click="isSelected(item) ? editItem(item, i) : removeItem(item, i)">
